...
class Inter(object):
	...
	def eval(self, s):
		...
		global exceptionis
		exceptionis = None
		r =  guile.scm_internal_catch(guile.scm_bool_t(), exception_body, s, exception_handler, None)
		if exceptionis != None:
			raise exceptionis
		return r
...
guile.scm_c_primitive_load.restype = SCMc
