...
#define SCHEME_IS_PAIR(o) (SCHEME_PAIRP(o) || SCHEME_MUTABLE_PAIRP(o))
int scheme_pair_p(Scheme_Object *o)
{
    return SCHEME_IS_PAIR(o);
}
...
int scheme_alist_p(Scheme_Object *o)
{
    while (1)
    {
        ...
        if (!SCHEME_IS_PAIR(o))
            return 0;
        if (!SCHEME_IS_PAIR(SCHEME_CAR(o)))
            return 0;
        o = SCHEME_CDR(o);
    }
}
