...
INSN_MAP = {
    ...
    'pop' : INSTRUCTIONS[3],
    'push_local' : INSTRUCTIONS[4],
    'set_local' : INSTRUCTIONS[5],
    'push_local_depth' : INSTRUCTIONS[6],
    'set_local_depth' : INSTRUCTIONS[7],
    'push_literal' : INSTRUCTIONS[8],
    'push_0' : INSTRUCTIONS[9],
    'push_1' : INSTRUCTIONS[10],
    'push_nil' : INSTRUCTIONS[11],
    'push_true' : INSTRUCTIONS[12],
    'push_false' : INSTRUCTIONS[13],
    'dup' : INSTRUCTIONS[14],
    'goto' : INSTRUCTIONS[15],
    'goto_if_not_false' : INSTRUCTIONS[16],
    'goto_if_false' : INSTRUCTIONS[17],
    'fix_lexical' : INSTRUCTIONS[18],
    'fix_lexical_pop' : INSTRUCTIONS[19],
    'fix_lexical_depth' : INSTRUCTIONS[20],
    'dynamic_eval' : INSTRUCTIONS[21],
    'dynamic_set_local' : INSTRUCTIONS[22],
    'dynamic_set_local_depth' : INSTRUCTIONS[23]
}
